        ...
        <div class="container">
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    ...
                    $insert_query = "INSERT INTO `department`(`department_name`) VALUES ('$department_name')";
            ...
            ?>
                <h2 class="login-title mt-0">Add Department</h2>
                <form action="" method="post" class="register">
                    ...
                    <button class="btn btn-lg yellow-btn" type="submit" name ="submit">Add Department</button>
                    </div>
                </form>
            </div>
        </div>
