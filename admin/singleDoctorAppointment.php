...
if($_SESSION['r_username'] !== $username){
    echo "<script>alert('You cant see other appointment list!!')</script>";
    header('Location: doctorsList.php');
    exit;
}
// else{
//     echo "<script>location.href='singleDoctorAppointment.php'</script>";
// }
?>
      ...
      <div class="login">
         <div class="container">
            <div class="row d-flex justify-content-center">
               <h2 class="heading">See <?php include 'config.php'; $id = $_GET['r_username']; echo $id?>  Patient List</h2>
               <div class="col-xl-12 ">
                  <table class="table table-hover table-dark">
                     ...
                     <tbody>
                        <?php
                           include 'config.php';
                           $id = $_GET['r_username'];
                           $allData = mysqli_query($conn,"SELECT * FROM `appointment`  WHERE doctor='$id'");
