         ...
         <div class="container">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    include 'config.php';
                        if(isset($_POST['submit'])){
                            ...
                            $updateQuery ="UPDATE appointment SET `appointment_time`= '$appointment_time', `status`= '$status' WHERE id = '$id'";
            ...
            <!--update course php end -->
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="appointment-form">
                        ...
                        <div class="mb-3 input">
                        <label>Appointment Requested time:</label><input type="text" value="<?php echo $data['date_time'] ;?>" name="date_time" />
                        </div>
                        <div class="mb-3 input">
                        <label>Assign appointment time:</label><input type="datetime-local" value="<?php echo $data['appointment_time'] ;?>" name="appointment_time" />
                        </div>
                        <div class="mb-3 input">
                        <label>Status:</label><input type="text" value="<?php echo $data['status'] ;?>" name="status" /><br>
                        </div>
