               ...
               <?php
                    include 'config.php';
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $mobile=$_POST['mobile'];
                            $result = mysqli_query($conn ,"SELECT * FROM `appointment` WHERE name='$name' And mobile='$mobile'");
                    ...
                    ?>
                    <div>
                        <form action="" method="post" enctype="multipart/form-data" class="appointment-form mb-5">
